class CompanerosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @companero.save
        format.html { redirect_to @companero, notice: 'Mascota creada con exito.' }
  ...
  def update
    respond_to do |format|
      if @companero.update(companero_params)
        format.html { redirect_to @companero, notice: 'Mascota editada con exito.' }
  ...
  def destroy
    @companero.destroy
    respond_to do |format|
      format.html { redirect_to companeros_url, notice: 'Mascota eleiminada con exito.' }
  ...
  private
    ...
    def companero_params
      params.require(:companero).permit(:nombre, :edad, :raza, :dueno, :descripcion, :color, :peso, :tamano, :foto)
    end
end
